...
export const demoArtwork = [
  { id: 'demo-1', title: 'Demo Artwork 01', student: 'Demo Student A.', program: 'Studio Art', programSlug: 'studio-art', category: 'Watercolor', medium: 'Watercolor on paper', year: 2026, featured: true, image: '/demo/art-1.svg', awards: [{ competition: '[Draft] Demo Competition', awardName: '[Draft] Demo Award', year: 2026 }] },
  ...
  { id: 'demo-3', title: 'Demo Artwork 03', student: 'Demo Student C.', program: 'Studio Art', programSlug: 'studio-art', category: 'Drawing', medium: 'Colored pencil', year: 2025, featured: true, image: '/demo/art-3.svg', awards: [{ competition: '[Draft] Demo Competition', awardName: '[Draft] Demo Award', year: 2025 }] },
  ...
  { id: 'demo-6', title: 'Demo Artwork 06', student: 'Demo Student F.', program: 'Studio Art', programSlug: 'studio-art', category: 'Charcoal', medium: 'Charcoal', year: 2025, featured: true, image: '/demo/art-6.svg', awards: [{ competition: '[Draft] Demo Competition', awardName: '[Draft] Demo Award', year: 2025 }] },
];
