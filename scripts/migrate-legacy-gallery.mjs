...
const legacyRoot = process.argv[2] ? path.resolve(process.argv[2]) : path.resolve('legacy');
...
console.log(`Found ${filenames.length} unique legacy gallery images.`);
console.log('They will be created as DRAFT Studio Art documents so an administrator can add student/category metadata before publishing.\n');
